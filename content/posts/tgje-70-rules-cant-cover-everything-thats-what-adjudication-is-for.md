...
author: 塔迪Tardi
cover:
  image: /images/cover/AioGeoLab-cover-tgje-70-rules-cant-cover-everything-thats-what-adjudication-is-for.png
  alt: tgje-70-rules-cant-cover-everything-thats-what-adjudication-is-for
  caption:
schema:
  type: BlogPosting
  wordCount: auto
...
TocOpen: true
image:
commands: /Users/wyh/baidusync/OneAILtd/VibCX/tarditools/apublish/pub.sh tgje-70-rules-cant-cover-everything-thats-what-adjudication-is-for c i w b
publish:
  slug: tgje-70-rules-cant-cover-everything-thats-what-adjudication-is-for
  status: draft
  paths:
    cover_img:
    video:
